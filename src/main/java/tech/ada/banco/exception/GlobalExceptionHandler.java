...
public class GlobalExceptionHandler  {
   ...
   @ExceptionHandler(value= ConstraintViolationException.class)
    ...
    public ResponseEntity<ErrorResponse> handleContaInexistenteException(ContaInexistenteException ex) {
    ...
    public ResponseEntity<ErrorResponse> handleSaldoIndisponivelException(SaldoIndisponivelException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorResponse(HttpStatus.BAD_REQUEST.value(),ex.getMessage()));
    }

    @ExceptionHandler(ValorInvalidoException.class)
    public ResponseEntity<ErrorResponse> handleValorInvalidoException(ValorInvalidoException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new ErrorResponse(HttpStatus.BAD_REQUEST.value(),ex.getMessage()));
    }
